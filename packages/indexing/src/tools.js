...
export const listIndexedFilesTool = {
  definition: listIndexedFilesDef,
  execute: (_ctx) => listIndexedFilesForTool
}

export const readIndexedFileTool = {
  definition: readIndexedFileDef,
  execute: (_ctx) => readIndexedFileForTool
}

export const searchIndexedContextTool = {
  definition: searchIndexedContextDef,
  execute: (_ctx) => searchIndexedContextForTool
}

export const ALL_KNOWLEDGE_TOOLS = [
