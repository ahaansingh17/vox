...
```sh
npm install @info-arnav/vox-mcp
```

## Usage

```js
import { connectMcpServer, setLogger } from '@info-arnav/vox-mcp'
...
terminateStaleSession(url, id) // HTTP DELETE to terminate
